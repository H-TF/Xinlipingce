...
public class ZixunshiCollectionView extends ZixunshiCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String zixunshiCollectionValue;
	...
	public ZixunshiCollectionView() {

	}

	public ZixunshiCollectionView(ZixunshiCollectionEntity zixunshiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, zixunshiCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getZixunshiCollectionValue() {
				return zixunshiCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setZixunshiCollectionValue(String zixunshiCollectionValue) {
				this.zixunshiCollectionValue = zixunshiCollectionValue;
			}
