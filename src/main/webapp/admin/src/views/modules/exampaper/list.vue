                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xinlipingcexitong/upload/exampaperMuBan.xls"
                        >批量导入试卷表数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('exampaper','导入导出')"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('exampaper','问卷') && scope.row.exampaperTypes==1" type="primary" icon="el-icon-edit" size="mini" @click="saveExamrecord(scope.row.id)">{{ contents.tableBtnFont == 1?'问卷':'' }}</el-button>
