<template>
    <div style="backgroundImage: url('/xinlipingcexitong/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">医疗健康系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="医师姓名" class="input" v-if="tableName=='zixunshi'">
                            <el-input v-model="ruleForm.zixunshiName" autocomplete="off" placeholder="医师姓名"  />
                        </el-form-item>
                        <el-form-item label="医师手机号" class="input" v-if="tableName=='zixunshi'">
                            <el-input v-model="ruleForm.zixunshiPhone" autocomplete="off" placeholder="医师手机号"  />
                        </el-form-item>
                        <el-form-item label="医师身份证号" class="input" v-if="tableName=='zixunshi'">
                            <el-input v-model="ruleForm.zixunshiIdNumber" autocomplete="off" placeholder="医师身份证号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='zixunshi'">
                            <el-input v-model="ruleForm.zixunshiEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.zixunshiName)&& 'zixunshi'==this.tableName){
                                this.$message.error('医师姓名不能为空');
                                return
                            }
                             if('zixunshi' == this.tableName && this.ruleForm.zixunshiPhone&&(!this.$validate.isMobile(this.ruleForm.zixunshiPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.zixunshiIdNumber)&& 'zixunshi'==this.tableName){
                                this.$message.error('医师身份证号不能为空');
                                return
                            }
                            if('zixunshi' == this.tableName && this.ruleForm.zixunshiEmail&&(!this.$validate.isEmail(this.ruleForm.zixunshiEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                this.$http({
