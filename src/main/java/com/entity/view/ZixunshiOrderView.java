...
public class ZixunshiOrderView extends ZixunshiOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 预约状态的值
		*/
		private String zixunshiOrderYesnoValue;
	...
	public ZixunshiOrderView(ZixunshiOrderEntity zixunshiOrderEntity) {
		try {
			...
			* 获取： 预约状态的值
			*/
			public String getZixunshiOrderYesnoValue() {
				return zixunshiOrderYesnoValue;
			}
			/**
			* 设置： 预约状态的值
			*/
			public void setZixunshiOrderYesnoValue(String zixunshiOrderYesnoValue) {
				this.zixunshiOrderYesnoValue = zixunshiOrderYesnoValue;
			}
