...
import center from '@/views/center'
    ...
    import dictionaryZixunshiOrderYesno from '@/views/modules/dictionaryZixunshiOrderYesno/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryZixunshiOrderYesno',
        name: '预约状态',
        component: dictionaryZixunshiOrderYesno
    }
    ,{
        path: '/config',
        name: '轮播图',
