    ...
    */
    ...
    public R save(@RequestBody ZixunshiEntity zixunshi, HttpServletRequest request){
        ...
        if(zixunshiEntity==null){
            ...
            return R.error(511,"账户或者医师手机号或者医师身份证号已经被使用");
        }
    }
...
//                            zixunshiEntity.setZixunshiName(data.get(0));                    //医师姓名 要改的
//                            zixunshiEntity.setZixunshiPhone(data.get(0));                    //医师手机号 要改的
//                            zixunshiEntity.setZixunshiIdNumber(data.get(0));                    //医师身份证号 要改的
...
//                            zixunshiEntity.setCreateTime(date);//时间
                        ...
                        if(zixunshiEntities_zixunshiPhone.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [医师手机号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
                         //医师身份证号
                        ...
                        if(zixunshiEntities_zixunshiIdNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [医师身份证号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(zixunshi.getId(),username, "zixunshi", "医师");
        R r = R.ok();
        r.put("token", token);
        r.put("role","医师");
...
//    	ValidatorUtils.validateEntity(user);
        ...
        ZixunshiEntity zixunshiEntity = zixunshiService.selectOne(queryWrapper);
        if(zixunshiEntity != null)
            return R.error("账户或者医师手机号或者医师身份证号已经被使用");
        zixunshi.setCreateTime(new Date());
        zixunshiService.insert(zixunshi);
        return R.ok();
    }
